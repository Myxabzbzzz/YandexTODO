...
import com.example.yandextodo.Model.FormState
import com.example.yandextodo.Model.ListItemState
    ...
    fun getTaskState(task: TodoListResponse.TodoItemResponse): ListItemState {
        ...
        return when {
            ...
            isCompleted -> ListItemState(
                ...
                iconResId = R.drawable.unchecked_normal,
